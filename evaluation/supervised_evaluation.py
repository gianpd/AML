        ...
        for class_weight in CLASS_WEIGHTS:
            ...
            for m in CLFs:
                with mlflow.start_run(nested=True, run_name=f'{m}-{cv}-{c_weight}') as run:
                    ...
                    mlflow.log_metrics({
                        f'avg_f1_test_{m}':       avg_f1_test,
                        f'std_f1_test_{m}':       std_f1_test,
                        f'avg_micro_f1_test_{m}': avg_micro_f1_test,
                        f'std_micro_f1_test_{m}': std_micro_f1_test,
                    })
                    ...
                    mlflow.log_metrics({
                        f'accuracy_{m}':  model_scores['accuracy'],
                        f'f1_micro_{m}':  model_scores['f1_micro'],
                        f'f1_macro_{m}':  model_scores['f1_macro'],
                        f'precision_{m}': model_scores['precision'],
                        f'recall_{m}':    model_scores['recall'],
                        f'roc_auc_{m}':   model_scores['roc_auc']
                    })
